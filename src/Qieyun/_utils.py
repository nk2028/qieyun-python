...
def 轉號_韻圖母_切韻韻2切韻開合(轉號, 韻圖母, 切韻韻):
    if 韻圖母 in '幫滂並明非敷奉微' or 切韻韻 not in 常量.開合皆有的韻:
        return ''
    if 轉號 in (4, 6, 9, 13, 15, 17, 19, 21, 23, 27):
        return '開'
    if 轉號 in (5, 7, 10, 14, 16, 18, 20, 22, 24, 28):
        return '合'
    raise NotImplementedError(轉號)
